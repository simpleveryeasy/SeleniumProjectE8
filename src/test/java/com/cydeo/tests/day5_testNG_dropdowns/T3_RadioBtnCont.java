...
public class T3_RadioBtnCont {
    ...
    public static void main(String[] args) {
        ...
        //3. Locate name = sport radio buttons and store them in a list
        List<WebElement> sportRadioBtns = driver.findElements(By.name("sport"));

        //4. Loop through the list of radio buttons and select matching result hockey.
